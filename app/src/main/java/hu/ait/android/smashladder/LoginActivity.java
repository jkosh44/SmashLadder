...
//!!!!! NOTE: Change autocomplete from reading your contacts to getting all users from Parse!!!!!
        ...
        if (cancel) {
            ...
            ParseUser.logInInBackground(email, password, new LogInCallback() {
                ...
                public void done(ParseUser user, ParseException e) {
                    ...
                    if (e == null) {
                        Intent mainActIntent = new Intent(LoginActivity.this, PlayerListActivity.class);
